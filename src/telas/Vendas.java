...
/**
 * Tela de vendas. Permite a inserção e
 * busca de vendas. Os dados das vendas são armazenados em um banco de dados
...
public class Vendas extends JFrame {
	...
	public Vendas() {
		...
		tableModel = new DefaultTableModel(new Object[][] {},
				new String[] { "Produto", "Quantidade", "Valor", "Total" });
		...
		/**
	     * Realiza a inclusão de um produto na lista de vendas.
	     */
		...
		/**
	     * Realiza a finalização da venda
	     */
	...
	private void finalizarVenda() {
		try {
			Connection con = Conexao.conexao();
			String sql = "UPDATE produtos SET quantidade = quantidade - ? WHERE nome = ?"; // Altere para o nome da
																							// coluna correta
			PreparedStatement stmt = con.prepareStatement(sql);
